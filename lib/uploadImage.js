 ...
 * @param {string} folder - The folder to upload to (default: 'dashboard-media')
 ...
 */
export const uploadImageToCloudinary = async (file, folder = 'dashboard-media', imageTitle = '', altText = '') => {
  try {
